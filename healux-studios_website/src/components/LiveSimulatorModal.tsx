...
export default function LiveSimulatorModal({ initialSite = "activemotion-physio", onClose }: LiveSimulatorModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col h-screen w-screen bg-[#030712] text-white overflow-hidden">
      ...
      <header className="h-16 px-6 glass-panel border-b border-white/5 flex items-center justify-between shrink-0 z-30">
        <div className="flex items-center gap-4">
          <button 
            onClick={handleBack}
            className="flex items-center gap-2 text-xs font-bold text-gray-400 hover:text-white transition-colors uppercase tracking-wider bg-white/5 px-3 py-1.5 rounded-lg border border-white/5 cursor-pointer"
          >
